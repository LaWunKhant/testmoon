...
<body>
    ...
    <div class="container">
         {{-- Back button to the tenant list for this house (needs house ID, which we get from the tenant) --}}
         {{-- Ensure the 'house' relationship is eager loaded if you use this --}}
         @if ($tenant->house)
